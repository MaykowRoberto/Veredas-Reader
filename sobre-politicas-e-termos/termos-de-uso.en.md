...
12.3. **Model use restrictions.** As required by the OpenRAIL-M license, by using the natural voice you agree **not** to use the model, or the audio it generates:
...
12.4. Audio generated by the natural voice is meant for your personal reading of content you imported yourself, within the limits of section 6. You are responsible for any use you make of that audio. The full text of the model license is available under **About > Open-source licenses > Supertonic 3 (model)**.
